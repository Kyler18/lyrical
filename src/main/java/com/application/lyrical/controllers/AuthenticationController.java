...
import com.application.lyrical.models.dto.LoginFormDTO;
import com.application.lyrical.models.dto.RegisterFormDTO;
...
public class AuthenticationController {
    ...
    public String index(Model model) {
        model.addAttribute("title", "Lyrical");
        model.addAttribute("search", apiresults);
        return "index";
    }
